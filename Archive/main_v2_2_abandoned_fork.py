...
This is not yet fully real-time, though it is close.
"""
...
# Todos
# TODO: Where's the mystery energy coming from?  Do we need to switch to R4?  Trapezoidal?
...
def repeatedly_simulate():
    """Call simulate_and_draw_frame repeatedly, with the right timing."""
    global dt
...
# User-set parameters
dt = 0.01  # Must be a multiple of 0.001
g = 9.81
w0, w1 = 0, 0
theta0, theta1 = 0, 0
m0, m1 = 1, 1
...
sim_canvas.after(int(dt*1000), repeatedly_simulate)
sim_canvas.mainloop()
